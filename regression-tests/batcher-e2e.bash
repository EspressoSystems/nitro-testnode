...
docker compose run --detach scripts send-l2 --ethamount 1 --to user_l2user --times 10000000 --delay 1000 --wait

echo "sending delayed tx"
docker compose run --detach scripts send-l2-delayed --ethamount 1 --to user_delayed_user --from espresso-sequencer --times 1000000 --delay 2000 --wait
