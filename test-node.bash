...
ESPRESSO_DEFAULT_VERSION=ghcr.io/espressosystems/nitro-espresso-integration/nitro-node:v3.9.2-espresso-v1.0.0
...
if $espresso; then
    ...
    DEFAULT_ESPRESSO_NITRO_CONTRACTS_BRANCH=develop
